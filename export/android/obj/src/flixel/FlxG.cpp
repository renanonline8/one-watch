...
Void FlxG_obj::init( ::flixel::FlxGame Game,int Width,int Height,Float Zoom){
{
		...
		HX_STACK_LINE(451)
		::flixel::input::touch::FlxTouchManager _g4 = ::flixel::input::touch::FlxTouchManager_obj::__new();		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(451)
		::flixel::input::touch::FlxTouchManager _g5 = ::flixel::FlxG_obj::inputs->add_flixel_input_touch_FlxTouchManager(_g4);		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(451)
		::flixel::FlxG_obj::touches = _g5;
		HX_STACK_LINE(455)
		::flixel::input::gamepad::FlxGamepadManager _g6 = ::flixel::input::gamepad::FlxGamepadManager_obj::__new();		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(455)
		::flixel::input::gamepad::FlxGamepadManager _g7 = ::flixel::FlxG_obj::inputs->add_flixel_input_gamepad_FlxGamepadManager(_g6);		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(455)
		::flixel::FlxG_obj::gamepads = _g7;
		HX_STACK_LINE(459)
		::flixel::input::android::FlxAndroidKeys _g8 = ::flixel::input::android::FlxAndroidKeys_obj::__new();		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(459)
		::flixel::input::android::FlxAndroidKeys _g9 = ::flixel::FlxG_obj::inputs->add_flixel_input_android_FlxAndroidKeys(_g8);		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(459)
		::flixel::FlxG_obj::android = _g9;
		HX_STACK_LINE(463)
		::flixel::input::FlxAccelerometer _g10 = ::flixel::input::FlxAccelerometer_obj::__new();		HX_STACK_VAR(_g10,"_g10");
		HX_STACK_LINE(463)
		::flixel::FlxG_obj::accelerometer = _g10;
		HX_STACK_LINE(465)
...
void FlxG_obj::__boot()
{
	...
	VERSION= ::flixel::system::FlxVersion_obj::__new((int)3,(int)3,(int)8,null());
	elapsed= (int)0;
	maxElapsed= 0.1;
	fullscreen= false;
