...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(25)
		::openfl::_legacy::Lib_obj::setPackage(HX_CSTRING("HaxeFlixel"),HX_CSTRING("one-watch"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
		...
		HX_STACK_LINE(41)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::openfl::_legacy::Lib_obj::HARDWARE) | int(::openfl::_legacy::Lib_obj::ALLOW_SHADERS))) | int(::openfl::_legacy::Lib_obj::REQUIRE_SHADERS))) | int((int)0))) | int((int)0))) | int(::openfl::_legacy::Lib_obj::RESIZABLE))) | int((int)0))) | int(::openfl::_legacy::Lib_obj::VSYNC))) | int(::openfl::_legacy::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("one-watch"),null(),null());
	}
return null();
}
